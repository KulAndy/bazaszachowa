        ...
        <div id="left_content2" class="float_left">
            <details open>
                ...
                <ul>Możliwe parametry wyszukiwania:
                    ...
                    <li>
                        <ul>baza
                            <li>Polska - turnieje głównie z Polski ( zwłaszcza pobrane z ChessArbitra), ok 500 tys. , szybsza baza </li>
                            <li>Całość - wszystkie partie, ok 9 mln, wolniejsza baza</li>
                        </ul>
                    </li>
                    <li>
                        <ul>Wyszukiwanie (wielkość liter nie ma znaczenia)
                            <li>Zwykłe - zadziała zarówno wpisanie "Nowak, Jan" jak i "Nowak, J" , można stować jokery ( "_" - jeden dowolny znak, "%" - dowolny ciąg znaków, "\" - neguje joker jak zwykły znak)</li>
                            <li>Dokładne - wyszuka tylko po wpisaniu "Nowak, Jan", znacznie szybsze, zalecane jeśli zna się pełne imię i nazwisko gracza/y
                        </ul>
                    </li>
                </ul>
            </details>
