<?php
    echo '<div id="content"><article">Całość strony jest udostępniona na następujących zasadach:
        <ul>
            <li>użytkownik ma prawo używać strony w dowolnym celu</li>
            <li>użytkownik ma prawo do analizowania strony*</li>
            <li>użytkownik ma prawo do kopiowania strony</li>
            <li>użytkownik ma prawo do udoskonalania i publicznego rozpowszechniania ulepszeń strony*</li>
