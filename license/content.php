<article>Całość strony jest udostępniona na następujących zasadach:
    <ul>użytkownik
        ...
        <li> ma prawo do udoskonalania i publicznego rozpowszechniania ulepszeń strony*</li>
        <li> nie może zmienić licencji</li>
        <li> nie może pobierać opłat za projekt, w którym został wykorzystany jakikolwiek element z tej
            strony*</li>
        <li> jeśli skorzysta z wyszukiwarki, to ma obowiązek sprawdzenia swoich gier na dany moment z
            minimum
